label endings_forestShed:
    label .ending_oilDrums_mediocre:
        ...
        # vertical columns
        call screen game_over("you_died.png") with blinds
        return
    ...
    label .ending_oilDrums_lowApproval:
        ...
        """   
        # ..squares
        call screen game_over("you_died.png") with squares
        return
    ...
    label .ending_staceyRuns_lowApproval:
        ...
        # weird pixellation
        call screen game_over("you_died.png") with pixellate
        return
    ...
    label .ending_underTable_bootsInBag:
        ...
        call screen game_over("you_died.png") with dissolve
        return
    ...
    label .ending_underTable_cutHand:
        ...
        call screen game_over("you_died.png") with fade
        return
